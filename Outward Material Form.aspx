<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Outward Material Form.aspx.cs" Inherits="SAMAGRA.WebForm71" %>
...
<body style="background-color:gainsboro">
   ...
   <div  class="container-fluid">
        <div class="row">
            <div class="col-lg-12">
                <div class="col-lg-6"style="margin-left:300px;margin-left:25%;width:700px">
                  <h1 style="text-align:center;font-family:'Times New Roman';font-size:xx-large;font-weight:bolder;color:black;">Outward Material Form</h1>
                    <br />
        <asp:Label ID="Label1" runat="server" Text="Invoice No" Style="font-size:x-large">Invoice No/ Dc No:</asp:Label>
          <br />
<asp:TextBox ID="TextInvoiceNo" CssClass="form-control" TextMode="MultiLine" PlceHolder="enter" runat="server"></asp:TextBox>
    <br />
<asp:Label ID="Label5" runat="server" Text="Invoice copy" Style="font-size:x-large">Invoice copy / Dc copy:</asp:Label>
<br />
...
<br />
<asp:Label ID="Label2" runat="server" Text="dateofOutward" Style="font-size:x-large">date of Outward:</asp:Label>
                <br />
<asp:TextBox ID="TextdateofOutward" CssClass="form-control" TextMode="Date" runat="server"></asp:TextBox>
        <br />
<asp:Label ID="Label3" runat="server" Text="Quantity" Style="font-size:x-large">Quantity:</asp:Label>
        <br />
<asp:TextBox ID="Textquantity" CssClass="form-control" TextMode="Number" runat="server"></asp:TextBox>
        <br />
<asp:Label ID="Label4" runat="server" Text="Item description" Style="font-size:x-large">Item description:</asp:Label>
        <br />
<asp:TextBox ID="TextItemdescription" CssClass="form-control"  TextMode="MultiLine" runat="server"></asp:TextBox>
        <br /> 
<asp:Label ID="Label6" runat="server" Text="CustomerName" Style="font-size:x-large;font-weight:bolder">Customer Name:</asp:Label>
        <br />
<asp:TextBox ID="TextCustomerName" CssClass="form-control"  TextMode="SingleLine" runat="server"></asp:TextBox>
    <br />
<asp:Label ID="Label7" runat="server" Text="CustomerEmail" Style="font-size:x-large;font-weight:bolder">Customer Email:</asp:Label>
    <br />
<asp:TextBox ID="TextCustomerEmail" CssClass="form-control"  TextMode="Email" runat="server"></asp:TextBox>
    <br />
<asp:Button ID="Button2" CssClass="btn-block btn-success" runat="server" Text="Btn_Outward" OnClick="Button2_Click" />
   <br />
<asp:Button ID="Button3" CssClass="btn-block btn-primary" runat="server" Text="Create Invoice" OnClick="Button3_Click" />
                    <br />
                 </div>
              </div>
          </div> 
